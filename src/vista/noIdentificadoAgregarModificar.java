...
public class noIdentificadoAgregarModificar extends JPanel {
	...
	private JTextField tDescripcionFisica;
	/**
	 * Create the panel.
	 */
	public noIdentificadoAgregarModificar() {
		...
		textFieldApodo.setBounds(224, 95, 86, 20);
		add(textFieldApodo);
		...
		textFieldDescripcion.setBounds(224, 142, 86, 20);
		add(textFieldDescripcion);
		textFieldDescripcion.setColumns(10);
		
		JLabel lblDescripcionFisica = new JLabel("Agregar descripcion fisica:");
		lblDescripcionFisica.setForeground(new Color(255, 255, 255));
		lblDescripcionFisica.setBounds(68, 182, 169, 14);
		add(lblDescripcionFisica);
		
		tDescripcionFisica = new JTextField();
		tDescripcionFisica.setBounds(224, 179, 86, 20);
		add(tDescripcionFisica);
		tDescripcionFisica.setColumns(10);
		...
		bSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(esModificacion())
				{
					...
					noIdentificado.setDescripcionFisica(tDescripcionFisica.getText());
					...
					nuevoNoIdentificado.setDescripcionFisica(tDescripcionFisica.getText());
	...
	public noIdentificadoAgregarModificar(NoIdentificados nI) //MODIFICAR 
	{
		...
		tDescripcionFisica.setText(noIdentificado.getDescripcionFisica());
	}
