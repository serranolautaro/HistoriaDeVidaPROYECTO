...
public class IdentificadosModificarCentros extends JPanel {
	...
	public IdentificadosModificarCentros(Identificado identifi) {
		...
		identificadosDAO.traerCentroDeUnIdentificado(identificado);
		this.centrosEnLosQueYaEstuvo = identificado.getCentrosEnLosQueEstuvo();
	...
	public CCDTyE obtenerCentroVinculado() {
		...
		idao.traerCentroDeUnIdentificado(identificado);
		this.centrosEnLosQueYaEstuvo = identificado.getCentrosEnLosQueEstuvo();
